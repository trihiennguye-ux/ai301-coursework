...
I've used Python and some JavaScript/React, and I'm comfortable with git
and basic command-line workflows. I want to get better at reading and
navigating unfamiliar codebases and at writing tests for existing code.
I'd like to avoid issues that require heavy build-tooling setup or are
in languages I haven't touched, like C/C++.
